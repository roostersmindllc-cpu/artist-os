        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <FieldHint>
                Keep the status current so launch views and filters stay
                trustworthy.
              </FieldHint>
          ...
          <div className="space-y-2">
            ...
            />
            <FieldHint>
              Optional for early ideas, but add it as soon as the release window
              is real.
            </FieldHint>
          ...
          <div className="space-y-2">
            ...
            />
            <FieldHint>
              Paste a hosted image URL for the MVP cover preview and catalog
              record.
            </FieldHint>
          ...
          <div className="space-y-2">
            ...
            />
            <FieldHint>
              Capture the story, positioning, or rollout notes the team should
              keep nearby.
            </FieldHint>
