...
export default function Icon() {
  return new ImageResponse(
    ...
    >
      <svg width="92" height="92" viewBox="0 0 160 160" fill="none">
        <defs>
          <linearGradient id="note" x1="34" y1="20" x2="112" y2="126" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="circuit" x1="84" y1="26" x2="146" y2="110" gradientUnits="userSpaceOnUse">
